...
// import Angelina2 from '../images/angelina2.jpg'
...
const Middle = () => {
  return (
    <div className='flex-column items-center justify-center mt-10 mx-5 lg:mx-0'>
        <p className='text-xl text-center mb-7 lg:text-3xl lg:my-12 mt-[-20px]'>Shadowline Media have acquired :</p>
        ...
        <div className='first-section flex-column lg:flex-row items-center justify-center lg:mx-7 md:mt-12 mt-[100px]'>
              ...
              <p className='text-[#448feb] text-xl md:text-[25px] font-medium text-center underline md:underline-offset-[5px] lg:my-8'>Angelina - Queen of Coffee</p>
        ...
        <hr className='my-7 mx-0 border-2 lg:mx-12' />
         ...
         <div className='second-section flex-column items-center justify-center lg:mx-7 md:ml-[-150px]'>
              ...
              <p className='text-[#448feb] text-xl md:text-[28px] font-medium text-center underline md:underline-offset-[5px] lg:my-5'>George Best</p>   
        ...
        <button className='bg-[#448feb] text-white py-2 px-4 mt-10 mx-9 md:mx-[100px] lg:mx-[400px] rounded'>
        ...
        <hr className='mt-7 mx-0 border-2 lg:mx-12' /> 
                                   ...
                                   {/* THIRD SECTION */}
         <div className='third-section flex-column items-center justify-center pb-2 md:pb-12 lg:mx-12'>
            <div>
                <p className='text-[#448feb] md:pt-12 text-base md:text-[27px] md:leading-8 font-medium text-left pl-7 lg:text-center'>
        ...
        <hr className='mb-7 mx-0 border-2 lg:mx-12' />
